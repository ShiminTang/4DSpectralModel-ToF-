...
% Last Modified by GUIDE v2.5 19-Feb-2019 03:09:36
...
% handles    structure with handles and user data (see GUIDATA)
 ...
 path1 = get(hObject,'String') %returns contents of edit1 as text
 handles.path1 = path1;
 guidata(hObject,handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
 path2 = get(hObject,'String') %returns contents of edit1 as text
 handles.path2 = path2;
 guidata(hObject,handles);
